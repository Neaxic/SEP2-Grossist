...
public class ProxyViewHandler implements ViewHandler
{
  ...
  public ProxyViewHandler(Stage stage, ViewModelFactory viewModelFactory)
  {
    this.stage = stage;
  ...
  @Override public void openView(String viewToOpen) throws IOException
  {
    viewHandler.openView(viewToOpen);
  }

  @Override public ViewModel getViewModelByViewName(String viewName)
  {
      ...
      throws IOException
  {
    ...
    else if (cvr == 1 && pw.equals("1234"))
    {
      ...
      start(stage, viewModelFactory, this);
    }
    else if (cvr == 2 && pw.equals("1234"))
    {
      viewHandler = new GrosserViewHandler();
      start(stage, viewModelFactory, this);
    }
    else
    {
