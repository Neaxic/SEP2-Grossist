...
public class GrosserModel implements GrosserModelInterface
{
  ...
  @Override public void requestAllWaresAndAmounts()
  {
    client.requestGrosserProducts();
  }

  @Override public void deleteItem(Product product)
  {
    client.deleteWare(product);
  }

  @Override public void increaseStock(
      Pair<Product, Integer> productAndAmountToIncrease)
  {
    client.increaseStock(productAndAmountToIncrease);
  }

  @Override public void reduceStock(
